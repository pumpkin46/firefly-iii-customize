...
import YearlyOverview from './components/real_estate_management/YearlyOverview';
...
Vue.component('yearly-overview', YearlyOverview);
...
new Vue({
    ...
    render: (createElement) => {
        return createElement(YearlyOverview, {props: props});
    },
});
