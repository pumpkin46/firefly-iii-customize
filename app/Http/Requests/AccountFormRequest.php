...
class AccountFormRequest extends FormRequest
{
    ...
    public function getAccountData(): array
    {
        $data = [
            ...
            'phone_number'            => $this->string('phone_number'),
            'email'                   => $this->string('email'),
            'emergency_contact'       => $this->string('emergency_contact'),
            'rent_start_date'         => $this->date('rent_start_date'),
            'rent_end_date'           => $this->date('rent_end_date'),
            'apartment_nr'            => $this->string('apartment_nr'),
            'expense_account'         => $this->string('expense_account'),
            'headline'                => $this->string('headline'),
            'zip_code'                => $this->string('zip_code'),
